    ...
    <%@ page import="java.util.List" %>
        <%@ page import="es.taw.proyectotaw.Entity.UsuarioEntity" %>
            <%@ page import="es.taw.proyectotaw.Entity.EmpresaEntity" %>
                <%@ page import="es.taw.proyectotaw.ui.FEditarEmpresa" %><%-- Created by IntelliJ IDEA. User: x Date:
                            ...
                            <% FEditarEmpresa fEditarEmpresa=(FEditarEmpresa) request.getAttribute("fEditarEmpresa");
                                ...
                                <body>
                                    ...
                                    <%--@elvariable id="fEditarEmpresa" type="" --%>
                                        <form:form method="post" modelAttribute="fEditarEmpresa"
                                            action="/guardarEmpresa">
                                            Nombre:
                                            <form:input path="nombre" size="30" maxlength="30" /><br />
                                            CIF:
                                            <form:input path="cif" size="30" maxlength="30" /><br />
